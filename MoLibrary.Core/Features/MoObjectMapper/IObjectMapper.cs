...
namespace MoLibrary.Core.Features.MoObjectMapper;
...
public class DefaultObjectMapper(IMapper mapper) : IObjectMapper
{
...
{
    public static void AddMoObjectMapper(this IServiceCollection services)
    {
