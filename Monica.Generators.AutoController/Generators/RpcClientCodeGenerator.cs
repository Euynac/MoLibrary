...
internal static class RpcClientCodeGenerator
{
        ...
        List<HandlerMetadata> handlers)
    {
        ...
        // Namespace
        var clientNamespace = $"{contractNamespaceRoot}.AppInterfaces";
        ...
        string httpImplType)
    {
        ...
        var interfaceNamespace = $"{contractNamespaceRoot}.AppInterfaces";
        ...
        // Namespace
        var clientNamespace = $"{contractNamespaceRoot}.Implements";
        sb.AppendLine($"namespace {clientNamespace};");
        sb.AppendLine();
