...
def build_action_prompt(changed: list[dict[str, Any]], all_scoped: list[dict[str, Any]]) -> str:
    ...
    print(
        ...
        "- Before editing Monica code, read AGENTS.md and invoke the relevant Monica skills.\n"
        "- For Blazor/MudBlazor UI changes, invoke $monica-ui-development.\n"
        "- For UI visual verification/testing, invoke $monica-ui-bridge-debug and start Monica.Docs as the bridge project when practical.\n"
        "- Prefer delegating non-trivial Monica development fixes to Codex; explicitly tell Codex to load AGENTS.md and the relevant Monica skills, including $monica-ui-bridge-debug for UI testing through the Monica.Docs bridge.\n"
