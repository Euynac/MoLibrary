...
Provides distributed lock functionality using Dapr's Distributed Lock API via the dedicated `DaprDistributedLockClient`. This module integrates Dapr's distributed locking capabilities into the Monica framework, enabling coordination and mutual exclusion across distributed applications.
...
- [Monica.Locker Module](../../Monica.Locker/README.md)

## Support

For issues or questions:
- File an issue in the Monica repository
