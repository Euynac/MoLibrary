...
using MoLibrary.Framework.UI.Swagger;
    ...
    public override void ClaimDependencies()
    {
        ...
        DependsOnModule<ModuleSwaggerGuide>().Register(swaggerOption =>
        {
            swaggerOption.ExtendSwaggerUIAction = c =>
            {
                ...
                c.InjectJavascript("../_content/MoLibrary.Framework.UI/UISwagger/custom.js");

                // Inject custom CSS for navigation buttons
                c.InjectStylesheet("../_content/MoLibrary.Framework.UI/UISwagger/custom.css");
