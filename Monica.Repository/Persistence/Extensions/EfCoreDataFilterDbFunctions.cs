...
public static class EfCoreDataFilterDbFunctions
{
    ...
    public static MethodInfo SoftDeleteFilterMethodInfo => typeof(EfCoreDataFilterDbFunctions).GetMethod(nameof(SoftDeleteFilter))!;
