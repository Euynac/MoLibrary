...
public static class ModelBuilderExtensions
{
    public static ModelBuilder ApplyConfiguration<TEntity>(ModelBuilder builder,
        IHasEntitySelfConfig<TEntity> configuration) where TEntity : Entity.Abstractions.Entity, IHasEntitySelfConfig<TEntity>
    {
        ...
        ILogger? logger = null)
    {
        ...
        foreach (var entityType in entityTypes)
        {
            ...
            try
            {
                // Skip if not a EntityBase
                if (!clrType.IsAssignableTo(typeof(Entity.Abstractions.Entity)))
                {
                    continue;
                }
