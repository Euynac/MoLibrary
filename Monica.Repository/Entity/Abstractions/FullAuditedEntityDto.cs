...
/// </summary>
[Serializable]
public abstract class FullAuditedEntityDto : EntityDto, IFullAuditedObject
{
...
[Serializable]
public abstract class FullAuditedEntityDto<TPrimaryKey> : EntityDto<TPrimaryKey>, IFullAuditedObject
{
    public DateTime CreationTime { get; set; }
    public DateTime? LastModificationTime { get; set; }
    public bool IsDeleted { get; set; }
