...
namespace Monica.DataChannel.Middlewares.DataTransformer;

/// <summary>
/// Base class for data transformation middleware.
/// </summary>
public abstract class DataTransformerMiddlewareBase : PipelineTransformMiddlewareBase, IDataConverterCore
{
