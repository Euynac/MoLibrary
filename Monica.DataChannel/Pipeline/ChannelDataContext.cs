...
{
    /// <summary>
    /// Initializes a new instance of <see cref="ChannelDataContext"/>.
    /// </summary>
    /// <param name="source">The origin side of the data.</param>
    /// <param name="data">The payload.</param>
    public ChannelDataContext(ChannelSide source, object? data)
    {
        Source = source;
        Data = data;
    }
    ...
    /// The value is either <see cref="ChannelSide.Inner"/> or <see cref="ChannelSide.Outer"/>.
    /// </summary>
    ...
    public ChannelDataContext CopyMetadata(ChannelDataContext data)
    {
