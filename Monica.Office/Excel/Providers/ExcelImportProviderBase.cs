...
namespace Monica.Office.Excel.Providers
{
    ...
    internal abstract class ExcelImportProviderBase<TWorkbook, TSheet, TRow, TCell>
    {
        /// <summary>
        /// Initializes a new instance
        /// </summary>
        protected ExcelImportProviderBase()
        {
        }
        ...
        /// <returns></returns>
        public List<ExcelSheetImportResult<TImportDto>> ProcessExcelFile<TImportDto>(
            byte[] fileBytes,
        ...
        /// <returns></returns>
        private List<ExcelSheetImportResult<TImportDto>> ProcessWorkbook<TImportDto>(Stream fileStream, ExcelImportOptions options) where TImportDto : class, new()
        {
            var dataList = new List<ExcelSheetImportResult<TImportDto>>();
        ...
        /// <param name="options">The import options</param>
        /// <returns></returns>
        private ExcelSheetImportResult<TImportDto> ProcessWorksheet<TImportDto>(TWorkbook workbook, int sheetIndex, ExcelImportOptions options) where TImportDto : class, new()
        {
            // Get the worksheet
            ...
            try
            {
                ...
                return new ExcelSheetImportResult<TImportDto>
                {
                    SheetName = sheetName,
        ...
        /// <param name="options">The import options</param>
        /// <returns></returns>
        private List<ExcelImportRowResult<TImportDto>> ProcessWorksheetData<TImportDto>(TWorkbook workbook, TSheet worksheet, ExcelHeaderCellInfo headerCellInfo, ExcelHeaderCellPropertyInfo headerCellProperties, ExcelImportOptions options) where TImportDto : class, new()
        {
            var rows = new List<ExcelImportRowResult<TImportDto>>();
        ...
        /// <param name="options">The import options</param>
        /// <returns></returns>
        protected abstract ExcelRowRange GetDataRowStartAndEndRowIndex(TWorkbook workbook, TSheet worksheet, ExcelImportOptions options);
