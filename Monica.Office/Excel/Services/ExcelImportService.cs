...
namespace Monica.Office.Excel.Services
{
    ...
    /// </summary>
    internal abstract class ExcelImportService : IExcelImporter
    {
        /// <summary>
        ...
        /// <returns></returns>
        public List<ExcelSheetImportResult<TImportDto>> Import<TImportDto>(string filePhysicalPath, Action<ExcelImportOptions>? optionAction = null) where TImportDto : class, new()
        {
            try
            {
        ...
        /// <param name="optionAction">Configures import options</param>
        /// <returns></returns>
        public Task<List<ExcelSheetImportResult<TImportDto>>> ImportAsync<TImportDto>(string filePhysicalPath, Action<ExcelImportOptions>? optionAction = null) where TImportDto : class, new()
        {
        ...
        /// <param name="optionAction">Configures import options</param>
        /// <returns></returns>
        public List<ExcelSheetImportResult<TImportDto>> Import<TImportDto>(byte[] fileBytes, Action<ExcelImportOptions>? optionAction = null) where TImportDto : class, new()
        {
            try
            {
        ...
        /// <param name="optionAction">Configures import options</param>
        /// <returns></returns>
        public Task<List<ExcelSheetImportResult<TImportDto>>> ImportAsync<TImportDto>(byte[] fileBytes, Action<ExcelImportOptions>? optionAction = null) where TImportDto : class, new()
        {
        ...
        /// <param name="optionAction">Configures import options</param>
        /// <returns></returns>
        public List<ExcelSheetImportResult<TImportDto>> Import<TImportDto>(
            Stream fileStream,
        ...
        /// <param name="optionAction">Configures import options</param>
        /// <returns></returns>
        public Task<List<ExcelSheetImportResult<TImportDto>>> ImportAsync<TImportDto>(Stream fileStream, Action<ExcelImportOptions>? optionAction = null) where TImportDto : class, new()
        {
        ...
        /// <returns></returns>
        protected abstract List<ExcelSheetImportResult<TImportDto>> ImplementImport<TImportDto>(Stream fileStream, Action<ExcelImportOptions>? optionAction) where TImportDto : class, new();
