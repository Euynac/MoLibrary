...
{
    /// <summary>
    /// Excel column font attribute (for export only)
    /// <para>1. Apply to classes and properties. It affects data rows only, not the header row.</para>
    /// <para>2. If both the class and the property define it, the property-level setting takes precedence.</para>
    /// </summary>
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Property)]
    public class DataFontAttribute : Attribute
    {
        /// <summary>
        /// Color index
