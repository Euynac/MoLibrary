    ...
    : IConfigurationEffectiveValueStore, IConfigurationHistoryStore, IConfigurationMetadataStore
{
    ...
    private ConfigurationValueHistoryEntity ToEntity(ConfigurationValueHistory history)
    {
        return new ConfigurationValueHistoryEntity
        {
            ...
            EffectiveOldValueJson = history.EffectiveOldValue is null ? null : JsonSerializer.Serialize(history.EffectiveOldValue),
            EffectiveNewValueJson = history.EffectiveNewValue is null ? null : JsonSerializer.Serialize(history.EffectiveNewValue),
    ...
    private static ConfigurationValueHistory ToHistory(ConfigurationValueHistoryEntity entity)
    {
        return new ConfigurationValueHistory
        {
            ...
            Version = entity.Version,
            TargetRevision = entity.TargetRevision,
            PreviousTargetRevision = entity.PreviousTargetRevision,
            EffectiveOldValue = JsonToStoredValue(entity.EffectiveOldValueJson),
            EffectiveNewValue = JsonToStoredValue(entity.EffectiveNewValueJson),
            EffectiveValueChanged = entity.EffectiveValueChanged,
            SchemaVersion = entity.SchemaVersion,
