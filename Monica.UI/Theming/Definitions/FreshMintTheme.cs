...
/// Designed to create a comfortable, quiet, and stress-free space atmosphere.
/// </summary>
public class FreshMintTheme : ThemeDefinitionBase
{
    public override string Name => "fresh_mint";
    public override string DisplayName => "清爽薄荷绿";
    public override string Description => "营造舒适、安静、无压力的空间氛围";
