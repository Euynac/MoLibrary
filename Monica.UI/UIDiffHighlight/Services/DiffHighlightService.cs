...
namespace Monica.UI.UIDiffHighlight.Services;
...
/// <summary>
/// Core implementation for text diff highlighting.
/// </summary>
public class DiffHighlightService(ILogger<DiffHighlightService> logger, IOptions<ModuleDiffHighlightOption> options, IDiffAlgorithm algorithm) : IDiffHighlight
{
