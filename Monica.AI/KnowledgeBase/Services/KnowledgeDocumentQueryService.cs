...
/// <summary>
/// Canonical query service for knowledge-base listing, document browsing, search, trees, and content reads.
/// </summary>
internal sealed class KnowledgeDocumentQueryService(
    KnowledgeBaseService knowledgeBaseService,
    KnowledgeDocumentService documentService) : IKnowledgeDocumentQueryService
{
        ...
        CancellationToken ct = default)
    {
        ...
        var inventory = await documentService.GetInventoryAsync(kbId, ct);
        return inventory
    ...
    {
        return await documentService.GetContentAsync(kbId, document, ct);
    }
