...
public class MemoryOperatorDynamicLinqProvider<TModel> : OperatorBase<TModel>, IAutoModelMemoryOperator<TModel>
    where TModel : class
{
    ...
    public MemoryOperatorDynamicLinqProvider(IAutoModelExpressionNormalizer<TModel> normalizer, IOptions<AutoModelExpressionOptions> options) : base(normalizer, options)
    {
