...
```bash
python .agents/skills/monica-ui-development/scripts/subset_ui_font.py --mode generate
```

Check that the committed subset is current after localization changes:

```bash
python .agents/skills/monica-ui-development/scripts/subset_ui_font.py --mode check
```
