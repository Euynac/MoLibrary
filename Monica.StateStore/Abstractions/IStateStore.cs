...
public interface IStateStore
{
    ...
    /// <summary>
    /// Saves state with ETag verification when the caller does not need the ETag generated by the successful write.
    /// Providers may use the legacy read-back implementation for compatibility; providers that can avoid the
    /// read-back should override this method.
    /// </summary>
    /// <typeparam name="T">State data type</typeparam>
    /// <param name="key">State key</param>
    /// <param name="value">State value</param>
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <param name="ttl">Time to live</param>
    /// <returns>True when the state was saved; false when the ETag did not match</returns>
    async Task<bool> TrySaveStateWithETagWithoutReadBackAsync<T>(string key, T value, string expectedETag,
        CancellationToken cancellationToken = default, TimeSpan? ttl = null)
    {
