...
public class TaskController : ControllerBase
{
    ...
    public TaskController(ICancellationManager cancellationManager)
    {
...
public class BatchController : ControllerBase
{
    ...
    {
        // 使用特定的取消令牌管理器实例
        var cancellationManager = _serviceProvider.GetRequiredKeyedService<ICancellationManager>("batch-processor");
