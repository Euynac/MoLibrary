...
public static class MoFrameworkCoreMonitorExtensions
{
    ...
    public static void UseEndpointsMoFrameworkCoreMonitor(this IApplicationBuilder app, string? groupName = "Core")
    {
        app.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapPost("/framework/units/domain-event/{eventKey}/publish", async ([FromRoute] string eventKey, [FromServices] IDistributedEventBus eventBus,[FromServices] IGlobalJsonOption jsonOption, [FromBody]JsonNode eventContent, HttpResponse response, HttpContext context) =>
            {
