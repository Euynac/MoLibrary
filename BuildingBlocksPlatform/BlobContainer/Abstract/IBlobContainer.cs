...
public interface IBlobContainer
{
    ...
    ///     If set to <code>false</code> (default), throws exception if there is already a blob in the container with the given
    ///     name.
    /// </param>
    ...
    ///     Use <see cref="GetOrNullAsync" /> if you want to get <code>null</code> if there is no blob with the given
    ///     <paramref name="name" />.
    /// </summary>
    /// <param name="name">The name of the blob</param>
    /// <param name="cancellationToken">Cancellation token</param>
