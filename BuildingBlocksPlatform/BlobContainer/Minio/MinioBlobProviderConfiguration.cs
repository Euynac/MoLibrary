...
public class MinioBlobProviderConfiguration
{
    ...
    {
        get =>
            _containerConfiguration.GetConfigurationOrDefault<string>(MinioBlobProviderConfigurationNames.BucketName);
    ...
    /// <summary>
    ///     accessKey is like user-id that uniquely identifies your account.This field is optional and can be omitted for
    ///     anonymous access.
    /// </summary>
    ...
    public bool CreateBucketIfNotExists
    {
        get => _containerConfiguration.GetConfigurationOrDefault(
            MinioBlobProviderConfigurationNames.CreateBucketIfNotExists, false);
        set => _containerConfiguration.SetConfiguration(MinioBlobProviderConfigurationNames.CreateBucketIfNotExists,
            value);
    }
}