...
public class MinioBlobProvider : BlobProviderBase, ITransientDependency
{
    ...
    public override async Task SaveAsync(BlobProviderSaveArgs args)
    {
        ...
        if (configuration.CreateBucketIfNotExists) await CreateBucketIfNotExists(client, containerName);
    ...
    public override async Task<bool> DeleteAsync(BlobProviderDeleteArgs args)
    {
        ...
        if (!await BlobExistsAsync(client, containerName, blobName)) return false;
    ...
    protected virtual IMinioClient GetMinioClient(BlobProviderArgs args)
    {
        ...
        if (configuration.WithSSL) client.WithSSL();
