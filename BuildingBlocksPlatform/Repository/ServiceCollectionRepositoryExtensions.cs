...
using BuildingBlocksPlatform.Repository.Registrar;
...
public static class MoEfCoreServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Adds a service of type <see cref="IDbContextProvider{T}"/> with the implementation type of <see cref="DefaultDbContextProvider{T}"/> to the specified <see cref="IServiceCollection"/>.
    /// </summary>
