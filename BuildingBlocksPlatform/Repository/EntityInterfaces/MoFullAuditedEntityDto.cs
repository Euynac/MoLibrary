...
/// </summary>
[Serializable]
public abstract class MoFullAuditedEntity : MoEntity, IFullAuditedObject
{
...
[Serializable]
public abstract class MoFullAuditedEntity<TPrimaryKey> : MoEntity<TPrimaryKey>, IFullAuditedObject
{
    public DateTime CreationTime { get; set; }
    public DateTime? LastModificationTime { get; set; }
    public bool IsDeleted { get; set; }
