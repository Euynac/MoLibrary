...
**Location**: `MoLibrary.UI/UIStackTrace/Components/StackTraceViewer.razor`
...
**Location**: `MoLibrary.UI/UIStackTrace/Services/StackTraceParserService.cs`
...
- **MoLibrary.JobScheduler.UI** - Displays job execution stack traces in the Job Instance Detail dialog
- **MoLibrary.DataChannel** - Shows channel exception stack traces in the Exception Details dialog
...
- **MoLibrary.UI** (UICore module)
- **MudBlazor**: For theme variables and responsive design
- **.NET 8.0 or higher**

## License

Part of MoLibrary framework - see project LICENSE file for details.
