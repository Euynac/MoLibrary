    ...
    : DecorationStrategy(targetInterface, serviceKey)
{
    ...
    private bool CanDecorateGenericInterface(Type serviceType)
    {
        ...
        return FindClosedTargetInterface(serviceType) is not null;
    }
    ...
    private Type GetActualDecoratorType(Type serviceType, Type decoratorType)
    {
        ...
        if (TargetInterface.IsGenericTypeDefinition)
        {
            var implementedInterface = FindClosedTargetInterface(serviceType);
    ...
    private Type? FindClosedTargetInterface(Type serviceType)
    {
        if (serviceType.IsGenericType && serviceType.GetGenericTypeDefinition() == TargetInterface)
        {
            return serviceType;
        }
