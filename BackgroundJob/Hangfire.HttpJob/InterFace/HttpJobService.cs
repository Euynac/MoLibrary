...
namespace Hangfire.HttpJob.InterFace
{
    public class HttpJobService : IHttpJobService
    {
        ...
        {
            RecurringJob.AddOrUpdate<Server.HttpJob>(httpJob.JobName, a => a.ExcuteAsync(httpJob, httpJob.JobName, httpJob.QueueName, httpJob.IsRetry, null), httpJob.Cron, new RecurringJobOptions()
            {
