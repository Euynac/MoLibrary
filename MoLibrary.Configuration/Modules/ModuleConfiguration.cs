...
using MoLibrary.Configuration.Controllers;
...
public class ModuleConfiguration(ModuleConfigurationOption option) : MoModuleWithDependencies<ModuleConfiguration, ModuleConfigurationOption, ModuleConfigurationGuide>(option), IWantIterateBusinessTypes
{
    ...
    public override void ClaimDependencies()
    {
        ...
        DependsOnModule<ModuleControllersGuide>().Register()
            .RegisterMoControllers<ModuleConfigurationController>(Option);
    }
