...
public class InterfaceProxyDecorationTests : TestBase
{
    ...
    public void CanDecorateInterfaceProxy_BasicInterface()
    {
        ...
        Assert.Equal("[Cached] User data: 1", userRepo.GetData(1));
        Assert.Equal("User_1", userRepo.GetUserName(1));
        Assert.Equal("[Cached] Product data: 2", productRepo.GetData(2));
        Assert.Equal("Product_2", productRepo.GetProductName(2));
    }
    ...
    public void CanDecorateInterfaceProxy_WithFunction()
    {
        ...
        Assert.Equal("[Logged] User data: 1", userRepo.GetData(1));
        Assert.Equal("User_1", userRepo.GetUserName(1));
    }
    ...
    public void CanDecorateInterfaceProxy_WithServiceProviderFunction()
    {
        ...
        Assert.Equal("[ServiceDependent] User data: 1", userRepo.GetData(1));
        Assert.Equal("User_1", userRepo.GetUserName(1));
    }
    ...
    public void CanDecorateInterfaceProxy_MultiLayerDecoration()
    {
        ...
        Assert.Equal("[Logged] [Cached] User data: 1", userRepo.GetData(1));
        Assert.Equal("User_1", userRepo.GetUserName(1));
    }
    ...
    public void CanDecorateInterfaceProxy_CombinedWithRegularDecoration()
    {
        ...
        Assert.Equal("[Specific] [Cached] User data: 1", specificDecorator.GetData(1));
        Assert.Equal("[Specific] User_1", specificDecorator.GetUserName(1));
