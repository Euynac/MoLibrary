...
public class DecorationTests : TestBase
{
    ...
    public void DecorationFunctionsProvideScopedServiceProvider()
    {
        ...
        var decorationFunctions = new Action<IServiceCollection>[]
        {
            ...
            {
                actual = sp;
                return new Decorator((IDecoratedService)obj);
            }),
    ...
    public void DependentServicesRetainTheirOwnScope()
    {
        ...
        using var scope = provider.CreateScope();
        var decorator1 = Assert.IsType<Decorator2>(scope.ServiceProvider.GetRequiredService<DecoratedService>());
        var decorator2 = Assert.IsType<Decorator2>(scope.ServiceProvider.GetRequiredService<DecoratedService>());
    ...
    private sealed class NullService : IService
    {
