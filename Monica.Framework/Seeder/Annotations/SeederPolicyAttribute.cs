...
/// <see cref="MaxAttempts"/> above one explicitly enables retry for non-cancellation failures. Failure behavior
/// is evaluated only after the final attempt fails.
/// </remarks>
...
public sealed class SeederPolicyAttribute : Attribute
{
    ...
    /// <summary>Gets or sets how the scheduler responds after this seeder exhausts its attempts.</summary>
    public SeederFailureBehavior FailureBehavior { get; set; } = SeederFailureBehavior.Inherit;
