...
public class PgSqlActivityStatus
{
    ...
    ///// <summary>
    ///// The OID of the database to which the user session is connected in the background. The OID of the database to which the user session is connected in the background.
    ///// </summary>
