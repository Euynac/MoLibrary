...
using Monica.Framework.ProjectUnits.Annotations;
...
public abstract class ProjectUnit(Type type, EProjectUnitType unitType)
{
    ...
    private static ProjectUnit? ConstructorDefaultAnalyzerFactory(ConstructorAnalysisContext context)
    {
        ...
        return ProjectUnitRegistry.ProjectUnitsByFullName.TryGetValue(context.ParameterType.FullName, out var unit) ? unit : null;
    }
   
    internal static ILogger Logger => Option.Logger;
    internal static ModuleProjectUnitsOption Option { get; set; } = null!;
    ...
    {
        Description = ProjectUnitDocumentationResolver.ExtractTypeDescription(Type);
    ...
    {
        Methods = ProjectUnitDocumentationResolver.GetPublicMethods(Type);
    }
    /// <summary>
    /// Initialization method metadata
    /// </summary>
    ...
    {
        Methods = ProjectUnitDocumentationResolver.GetPublicMethods(Type, typeof(T));
    }
