...
public abstract class CrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TRepository>(
    ...
    : CrudAppService<TEntity, TEntityDto, TEntityDto, TKey, TGetListInput, MoCrudDisableDto, MoCrudDisableDto,
...
public abstract class CrudAppService<TEntity, TEntityDto, TKey, TCreateInput, TUpdateInput, TRepository>(
    TRepository repository)
    : CrudAppService<TEntity, TEntityDto, TEntityDto, TKey, MoCrudPageRequestDto, TCreateInput, TUpdateInput,
        MoCrudDisableDto, TRepository>(repository)
    where TEntity : class, IMoEntity<TKey>
    where TEntityDto : IMoEntityDto<TKey>
    where TRepository : IMoRepository<TEntity, TKey>
...
public abstract class CrudAppService<TEntity, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput,
    TRepository>(
        TRepository repository)
    : CrudAppService<TEntity, TEntityDto, TEntityDto, TKey, TGetListInput, TCreateInput, TUpdateInput, MoCrudDisableDto, TRepository>(
        repository)
    where TEntity : class, IMoEntity<TKey>
    where TEntityDto : IMoEntityDto<TKey>
    where TRepository : IMoRepository<TEntity, TKey>
