...
public abstract class MoDomainEventHandler<TEvent> :
    MoEventHandler,
    IMoDistributedEventHandler<TEvent>
{
    /// <summary>
...
/// </summary>
/// <typeparam name="TEvent">The event payload type.</typeparam>
public abstract class MoLocalEventHandler<TEvent> :
    MoEventHandler,
    IMoLocalEventHandler<TEvent>
{
    /// <summary>
