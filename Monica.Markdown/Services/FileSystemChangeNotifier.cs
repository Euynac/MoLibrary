...
/// </summary>
public class FileSystemChangeNotifier : IMarkdownChangeNotifier
{
    private readonly ConcurrentDictionary<string, FileSystemWatcher> _watchers = new(
        StringComparer.OrdinalIgnoreCase);

    public event EventHandler<DocumentsChangedEventArgs>? DocumentsChanged;
        ...
        string groupKey, string filePath, DocumentChangeType changeType)
    {
        ...
        DocumentsChanged?.Invoke(this, new DocumentsChangedEventArgs(
