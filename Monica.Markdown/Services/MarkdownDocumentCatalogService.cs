...
/// </summary>
public class MarkdownDocumentCatalogService(
    IOptions<ModuleMarkdownOption> options,
    IMarkdownDocumentProvider documentProvider,
    ILogger<MarkdownDocumentCatalogService> logger) : IMarkdownDocumentCatalog, IDisposable
{
    ...
    private void OnDocumentsChanged(object? sender, MarkdownDocumentsChangedEventArgs e)
    {
        if (_changeNotifier is null)
        {
            return;
