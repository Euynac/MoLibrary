...
public sealed class GitRepositoryStatus
{
    ...
    /// <summary>
    /// Gets the bound Markdown document group keys.
    /// </summary>
    public required IReadOnlyList<string> BoundDocumentGroupKeys { get; init; }

    /// <summary>
    /// Gets the missing Markdown document group keys.
    /// </summary>
    public required IReadOnlyList<string> MissingDocumentGroupKeys { get; init; }
}
