...
public partial class UIGitRepositoriesPage : IAsyncDisposable
{
    ...
    [Inject]
    private GitUIService GitService { get; set; } = default!;
    ...
    [Inject]
    private IStringLocalizer<MarkdownResource> L { get; set; } = default!;
    ...
    private string GetProgressStageText(string? progressStage)
    {
        return progressStage switch
        {
            ...
            GitRepositoryProgressStages.RefreshingDocuments => L["GitDashboard:ProgressStages:RefreshingDocuments"],
