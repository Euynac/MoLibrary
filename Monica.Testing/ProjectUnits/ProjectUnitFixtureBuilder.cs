...
/// <summary>
/// Configures a raw Microsoft DI container for fast ProjectUnit collaboration tests.
/// </summary>
    ...
    where TUnit : class
{
    ...
    /// <summary>
    /// Builds the raw fixture and resolves the ProjectUnit without Monica module composition,
    /// conventional registration, dynamic proxies, or host lifecycle.
    /// </summary>
    public ProjectUnitFixture<TUnit> Build()
    {
        ...
        catch
        {
            ...
            rootProvider.DisposeAsync().AsTask().GetAwaiter().GetResult();
            throw;
        }
    }
